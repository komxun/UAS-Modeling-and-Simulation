...
%.. UAV Configuration Data

    D           =   0.150 ;                                                 % UAV diameter              (m)
    l           =   1.618 ;                                                 % UAV length                (m)
    S           =   ( pi / 4 ) * D^2 ;                                      % UAV area                  (m^2)
    Mass        =   30.0 ;                                                  % Mass                      (kg)
    ...
    XCG         =   0.809 ;                                                 % UAV C.G. Point 
    XREF        =   0.809 ;                                                 % UAV Moment Reference Point
...
%     K_phi       =   20.0 ; 
%     K_p         =   0.01 ; 
%     K_DC        =   0.8443;    % original : 0.8443
%     K_A         =   0.0270 ;
%     Omega_i     =   -6.5208;   % original : -6.5208
%     K_R         =   0.0777; % original : 0.0777

    % %.. Modified Control Gains

    K_phi       =   20.0*2 ; 
    K_p         =   0.01 ; 
    K_DC        =   0.8443/10;    % original : 0.8443
    K_A         =   0.0270 ;
    Omega_i     =   -6.5208/5;   % original : -6.5208
    K_R         =   0.0777; % original : 0.0777
